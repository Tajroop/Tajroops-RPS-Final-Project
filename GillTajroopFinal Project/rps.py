...
#main window
root = Tk()
root.title("Tajroop's Rock Paper Scissor Game")
...
# scores
playerScore = Label(root, text=0, font=100, bg="black", fg="blue")
computerScore = Label(root, text=0, font=100, bg="black", fg="red")
computerScore.grid(row=1, column=1)
playerScore.grid(row=1, column=3)


# indicators
user_indicator = Label(root, font=50, text="USER", bg="black", fg="Blue")
comp_indicator = Label(root, font=50, text="COMPUTER",bg="black", fg="red")
user_indicator.grid(row=0, column=3)
comp_indicator.grid(row=0, column=1)


# messages
msg = Label(root, font=50, bg="black", fg="Green")
